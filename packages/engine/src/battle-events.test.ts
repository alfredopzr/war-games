...
describe('formatBattleEvent', () => {
  it('formats move event', () => {
    const event: BattleEvent = {
      type: 'move', actingPlayer: 'player1', phase: 'movement',
  ...
  it('formats damage event', () => {
    const event: BattleEvent = {
      type: 'damage', actingPlayer: 'player1', phase: 'combat',
  ...
  it('formats kill event', () => {
    const event: BattleEvent = {
      type: 'kill', actingPlayer: 'player2', phase: 'combat',
  ...
  it('formats capture event', () => {
    const event: BattleEvent = {
      type: 'capture', actingPlayer: 'player1', phase: 'capture',
  ...
  it('formats recapture event', () => {
    const event: BattleEvent = {
      type: 'recapture', actingPlayer: 'player1', phase: 'capture',
  ...
  it('formats capture-damage event', () => {
    const event: BattleEvent = {
      type: 'capture-damage', actingPlayer: 'player2', phase: 'capture',
  ...
  it('formats capture-death event', () => {
    const event: BattleEvent = {
      type: 'capture-death', actingPlayer: 'player1', phase: 'capture',
  ...
  it('formats objective-change lost event', () => {
    const event: BattleEvent = {
      type: 'objective-change', actingPlayer: 'player1', phase: 'objective',
  ...
  it('formats objective-change seized event', () => {
    const event: BattleEvent = {
      type: 'objective-change', actingPlayer: 'player2', phase: 'objective',
  ...
  it('formats koth-progress event', () => {
    const event: BattleEvent = {
      type: 'koth-progress', actingPlayer: 'player1', phase: 'objective',
  ...
  it('formats round-end event', () => {
    const event: BattleEvent = {
      type: 'round-end', actingPlayer: 'player1', phase: 'round',
  ...
  it('formats game-end event', () => {
    const event: BattleEvent = {
      type: 'game-end', actingPlayer: 'player2', phase: 'round',
      winner: 'player2',
    };
  ...
  it('formats heal event', () => {
    const event: BattleEvent = {
      type: 'heal', actingPlayer: 'player1', phase: 'combat',
  ...
  it('formats counter event', () => {
    const event: BattleEvent = {
      type: 'counter', actingPlayer: 'player2', phase: 'combat',
  ...
  it('formats melee event', () => {
    const event: BattleEvent = {
      type: 'melee', actingPlayer: 'player1', phase: 'combat',
  ...
  it('formats reveal event', () => {
    const event: BattleEvent = {
      type: 'reveal', actingPlayer: 'player1', phase: 'combat',
